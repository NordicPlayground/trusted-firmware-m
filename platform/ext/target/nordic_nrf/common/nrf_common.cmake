...
elseif(COMPILER STREQUAL "GNUARM")
    set (S_SCATTER_FILE_NAME   "${NRF_COMMON_DIR}/gcc/nordic_nrf_s.ld")
...
elseif(BUILD_UART_STDOUT)
  ...
  elseif(SECURE_UART1)
    ...
    message(WARNING "nRF platforms likely need SECURE_UART1 enabled.")
  endif()
...
elseif(BUILD_NATIVE_DRIVERS)
  ...
  list(APPEND ALL_SRC_C_S "${NRF_COMMON_DIR}/native_drivers/mpu_armv8m_drv.c"
...
if(PSA_API_TEST_NS)
  embedded_set_target_link_defines(TARGET tfm_s DEFINES "PSA_API_TEST_NS")
endif()
