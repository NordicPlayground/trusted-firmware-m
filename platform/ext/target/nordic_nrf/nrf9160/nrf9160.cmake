...
elseif(BUILD_RETARGET)
  ...
  #list(APPEND ALL_SRC_C "${NRF9160_DIR}/retarget/platform_retarget_dev.c")
endif()
...
elseif(BUILD_TARGET_CFG)
  message(WARNING "BUILD_TARGET_CFG not implemented.")
  #list(APPEND ALL_SRC_C "${NRF9160_DIR}/target_cfg.c")
